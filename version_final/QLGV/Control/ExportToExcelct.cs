...
namespace QLGV.Control
{
...

    {
        ...
        public void Export(DataTable dt, string sheetName, string title)
        {
            ...
            cl1.Value2 = "Mã Mời Giảng";

            cl1.ColumnWidth = 30;

            Microsoft.Office.Interop.Excel.Range cl2 = oSheet.get_Range("B3", "B3");

            cl2.Value2 = "Mã Giáo Viên";
            ...
            Microsoft.Office.Interop.Excel.Range c2 = (Microsoft.Office.Interop.Excel.Range)oSheet.Cells[rowEnd, 6];
